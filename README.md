...
📜License
This project is licensed under the MIT License - see the LICENSE file for details. You are free to use, modify, and distribute this dashboard for personal or educational purposes, provided credit is given to the original author.

🤝 Contributing
Contributions, issues, and feature requests are welcome! If you have suggestions for new DAX measures or better visualizations for this coffee shop data, feel free to check the issues page.
